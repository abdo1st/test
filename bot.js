...
client.on('guildCreate', guild => {
  ...
  .setColor(0x5500ff)
  .setDescription(`**:شكراً لأضافة البوت الى سيرفرك**`)
...
if (message.content === '*invite') {
      message.author.send('  https://discordapp.com/oauth2/authorize?client_id=497894158321713152&permissions=8&scope=bot  |  اتفضل رابط البوت     ').catch(e => console.log(e.stack));
...
==================================================================
**سيرفر البوت :**
https://discord.gg/VQApFSQ
**صاحب البوت :**
@! ζ͜͡ẦỈĜẩĐ7ღ 👑(ŇỄẌŐ)💎#8390
`);
